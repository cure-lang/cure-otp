...
data SysStep : System -> System -> Type where
  StepHere : Step c c2 -> SysStep (SCons c rest) (SCons c2 rest)
  StepThere : SysStep rest rest2 -> SysStep (SCons c rest) (SCons c rest2)

sys_preservation : WTSys b -> SysStep b a -> WTSys a
sys_preservation (WSCons wtc wrest) (StepHere step) = WSCons (preservation wtc step) wrest
sys_preservation (WSCons wtc wrest) (StepThere s2) = WSCons wtc (sys_preservation wrest s2)
