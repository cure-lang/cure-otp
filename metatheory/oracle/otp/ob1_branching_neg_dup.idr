...
handle : (r : Req) -> (1 _ : ReplyCap r) -> Pair
handle GetCount cap = MkPair (reply cap R0) (reply cap R0)
handle (SetName _) cap = MkPair (reply cap R1a) Done
handle Ping cap = MkPair (reply cap R1b) Done
